...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;troll:))';
document.querySelector('.Description .modal-body').innerHTML = 'Lag rồi chỗ kìa kìa<i class="fas fa-heart"></i> ';
